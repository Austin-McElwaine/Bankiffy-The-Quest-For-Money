...
Last README file update: Fri Sep 26 19:27:39 CDT 2025
...
command
command.StockMarket
command.StockMarket.BotSettingsGUI
command.StockMarket.ManagementGUI
command.StockMarket.createDefaultBot
command.StockMarket.createDefaultBot.itemID
command.StockMarket.createDefaultBots
command.StockMarket.itemID
command.StockMarket.itemID.bot
command.StockMarket.itemID.bot.create
command.StockMarket.itemID.bot.remove
command.StockMarket.itemID.bot.settings
command.StockMarket.itemID.bot.settings.get
command.StockMarket.itemID.bot.settings.set
command.StockMarket.itemID.bot.settings.set.disabled
command.StockMarket.itemID.bot.settings.set.enabled
command.StockMarket.itemID.bot.settings.set.imbalancePriceChangeFactorLinear
command.StockMarket.itemID.bot.settings.set.imbalancePriceChangeFactorLinear.factor
command.StockMarket.itemID.bot.settings.set.imbalancePriceChangeFactorQuadratic
command.StockMarket.itemID.bot.settings.set.imbalancePriceChangeFactorQuadratic.factor
command.StockMarket.itemID.bot.settings.set.maxOrderCount
command.StockMarket.itemID.bot.settings.set.maxOrderCount.orderCount
command.StockMarket.itemID.bot.settings.set.maxTimer
command.StockMarket.itemID.bot.settings.set.maxTimer.timeMS
command.StockMarket.itemID.bot.settings.set.minTimer
command.StockMarket.itemID.bot.settings.set.minTimer.timeMS
command.StockMarket.itemID.bot.settings.set.orderRandomness
command.StockMarket.itemID.bot.settings.set.orderRandomness.randomness
command.StockMarket.itemID.bot.settings.set.pidD
command.StockMarket.itemID.bot.settings.set.pidD.pidD
command.StockMarket.itemID.bot.settings.set.pidI
command.StockMarket.itemID.bot.settings.set.pidI.pidI
command.StockMarket.itemID.bot.settings.set.pidIBounds
command.StockMarket.itemID.bot.settings.set.pidIBounds.pidIBounds
command.StockMarket.itemID.bot.settings.set.pidIntegratedError
command.StockMarket.itemID.bot.settings.set.pidIntegratedError.pidIntegratedError
command.StockMarket.itemID.bot.settings.set.pidP
command.StockMarket.itemID.bot.settings.set.pidP.pidP
command.StockMarket.itemID.bot.settings.set.targetItemBalance
command.StockMarket.itemID.bot.settings.set.targetItemBalance.balance
command.StockMarket.itemID.bot.settings.set.targetPriceRange
command.StockMarket.itemID.bot.settings.set.targetPriceRange.priceRange
command.StockMarket.itemID.bot.settings.set.timer
command.StockMarket.itemID.bot.settings.set.timer.timeMS
command.StockMarket.itemID.bot.settings.set.updateInterval
command.StockMarket.itemID.bot.settings.set.updateInterval.timeMS
command.StockMarket.itemID.bot.settings.set.volatility
command.StockMarket.itemID.bot.settings.set.volatility.volatility
command.StockMarket.itemID.bot.settings.set.volumeRandomness
command.StockMarket.itemID.bot.settings.set.volumeRandomness.volumeRandomness
command.StockMarket.itemID.bot.settings.set.volumeScale
command.StockMarket.itemID.bot.settings.set.volumeScale.volumeScale
command.StockMarket.itemID.bot.settings.set.volumeSpread
command.StockMarket.itemID.bot.settings.set.volumeSpread.volumeSpread
command.StockMarket.itemID.close
command.StockMarket.itemID.create
command.StockMarket.itemID.currentPrice
command.StockMarket.itemID.open
command.StockMarket.itemID.remove
command.StockMarket.load
command.StockMarket.order
command.StockMarket.order.cancelAll
command.StockMarket.order.cancelAll.itemID
command.StockMarket.order.username
command.StockMarket.order.username.cancelAll
command.StockMarket.order.username.cancelAll.itemID
command.StockMarket.save
command.StockMarket.setPriceCandleTimeInterval
command.StockMarket.setPriceCandleTimeInterval.seconds
...
command.bank
command.bank.allowItem
command.bank.allowItem.itemID
command.bank.disableNotifications
command.bank.enableNotifications
command.bank.load
command.bank.save
command.bank.setItemTransferTickInterval
command.bank.setItemTransferTickInterval.ticks
command.bank.setStartingBalance
command.bank.setStartingBalance.amount
command.bank.settingsGUI
command.bank.username
command.bank.username.bankManagementGUI
command.bank.username.create
command.bank.username.create.itemID
command.bank.username.create.itemID.balance
command.bank.username.delete
command.bank.username.delete.itemID
command.bank.username.setBalance
command.bank.username.setBalance.itemID
command.bank.username.setBalance.itemID.balance
command.bank.username.show
command.bcore_util
...
command.cpm.scaling.debug
command.cpm.scaling.debug.target
...
command.money
command.money.add
command.money.add.amount
command.money.add.username
command.money.add.username.amount
command.money.circulation
command.money.remove
command.money.remove.amount
command.money.remove.username
command.money.remove.username.amount
command.money.send
command.money.send.username
command.money.send.username.amount
command.money.set
command.money.set.amount
command.money.set.username
...
command.viaromana
command.viaromana.cache
command.viaromana.cache.clear
